                ...
                <div class="row center-block">
                  ...
                  <div class="col-xs-12 col-md-12 center-block">
                    <center style="padding: 10px 0px;">
                      <div class="btn-group">
                      <button type="button" class="btn btn-warning dropdown-toggle text-center" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Contate o seu Corretor</span>
                      </button>
                      <ul class="dropdown-menu">
                        <li><p><a href="https://api.whatsapp.com/send?phone=5551995513505" style="color: #000;" target="_blank">Whatsapp</a></p></li>
                        <li><p><a href="http://www.radardosimoveis.com.br/formulariovenda1.php" style="color: #000;" target="_blank">Formulário</a></p></li>
                      </ul>
                    </div>
                    </center>
                  </div>
	            ...
	            <div class="panel-heading" role="tab" id="headingOne">
	              <h4 class="panel-title">
	                <a class="imo-h4" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse'.$key->idimo.'" aria-expanded="true" aria-controls="collapse'.$key->idimo.'">
	                  <h4 >'.$key->tipoimo. ' - '.$key->bairro.'. '.$key->lougradouro.' - '.$key->nomecity.'       R$'.number_format($key->valorvendaimo, 2,',','.').'</h4>
	                </a>
	              </h4>
	            </div>
