...
if(empty($email)){
    session_start();
    $_SESSION['msg'] = '<div class="alert alert-danger" role="alert">Informe o email!</div>';
...
//-------------------------------------------------------------------------------------------
        ...
        if (!$mail->send()) {
            ...
            session_start();
            $_SESSION['msg'] = '<div class="alert alert-success" role="alert">Senha alterada, confira seu email!</div>';
        }
