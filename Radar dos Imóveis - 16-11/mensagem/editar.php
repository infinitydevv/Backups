...
<html>
    ...
    <!-- FIM navbar-top.php e navbar-top.css no head -->
		<div class="container"><br><br><br>
			<h1 class="text-center">Editar Mensagem</h1>
			<!-- <?php  
              echo $_SESSION['msg'];
              unset($_SESSION['msg']);
            ?> -->
				...
				<div class="row">
				    ...
				    <input type="hidden" class="form-control" value="<?php echo $idmens; ?>" id="idmens" name="idmens">
				  	<div class="form-group col-xs-12 col-sm-12">
				    	...
				    	<input type="text" class="form-control" id="assuntomens" value="<?php echo $result->assuntomens; ?>" name="assuntomens">
				  	</div>
				  	<div class="form-group col-xs-12 col-sm-12">
				    	<label for="descricaomens">Descrição:</label>
				    	<textarea class="form-control" id="descricaomens" name="descricaomens" rows="3"><?php echo $result->descricaomens; ?></textarea>
				  	</div>
				  	<div class="form-group col-xs-12 col-sm-4">
				    	<label for="datamens">Data:</label>
				    	<input type="date" class="form-control" value="<?php echo $result->datamens; ?>" id="datamens" name="datamens">
				  	</div>
				  	<div class="form-group col-xs-12 col-sm-4">
				    	<label for="horamens">Hora:</label>
				    	<input type="text" class="form-control" id="horamens" value="<?php echo $result->horamens; ?>" name="horamens">
				  	</div>
				  	<div class="col-xs-12 col-sm-4">
				  		<label for="horamens">     </label>
				  		<input class="btn btn-block btn-warning" type="submit" name="botao" value="Editar">
				  	</div>
				  	</div>
				</div>
				<?php endforeach;?>
