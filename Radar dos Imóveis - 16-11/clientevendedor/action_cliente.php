...
/*
		...
		if ($acao == 'incluir'):
			...
			$sql = 'INSERT INTO clientevendedor (nomecliven, cpf, cnpj,email,celular,telefone,logradouro,numero,cep,cidade,bairro,conjuge,cpfconjuge,pessoacontato,login,senha,status,obs)
		...
		if ($acao == 'editar'):
			...
			$sql = 'UPDATE clientevendedor SET nomecliven=:nome, cpf=:cpf, cnpj=:cnpj, status = :status, email=:email, celular=:celular,telefone=:telefone, logradouro=:logradouro, numero=:numero,cep=:cep,cidade=:cidade,bairro=:bairro,conjuge=:conjuge,cpfconjuge=:cpfconjuge,pessoacontato=:pessoacontato, login=:login, senha=:senha,	obs=:obs';
