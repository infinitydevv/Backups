								...
								<div class="nav-collapse collapse navbar-responsive-collapse">
									<div class="nav-menu">
										...
										<ul class="nav pull-right">
											...
											<li><a href="#box-service" class="list-items-nav" for="box-ache-facil">Serviços</a></li>
											<li><a href="area.php" class="list-items-nav" for="box-ache-facil">Adminstrativo</a></li>
										</ul>
									</div>
								</div>
							</div>
					...
					<div class="row-fluid">
						...
						<div class="list-service">
							...
							<div class="box-service">
				                ...
				                <p class="limit"  style="text-indent:1cm;  text-align: justify; ">
				                	Representação na compra e venda de imóveis residenciais, comerciais e rurais. 
									Os corretores do Radar dos Imóveis são especializados na compra e venda de imóveis 
									residenciais, comerciais e rurais e lhe prestam toda a segurança no momento da negociação.
									<br><br>NECESSIDADE DE COMPRAR?<br>
									Selecione um município e escolha o imóvel da sua preferência entre as ofertas. Verifique que 
									cada município possui um corretor responsável pelo atendimento. Contate-o, agende uma vista 
									ao imóvel e abra as negociações. Caso não encontre o imóvel desejado, contate o corretor e 
									solicite a busca de um novo imóvel que atenda as suas necessidades.

									<br><br>NECESSIDADE DE VENDER?<br>
									Indique a cidade onde deseja vender e envie mensagem ao corretor para disponibilizar sua oferta 
									no Radar dos Imóveis.
									
				                </p>
				                <a href="#" class="more">Compra e Venda</a>
							</div>
							<div class="box-service">
								<h3>Documentação</h3>
				                <p class="limit" style="text-indent:1cm;  text-align: justify; ">
				                	Regularização documentos: escrituras, inventários, IPTU, registros e toda documentação do seu imóvel.  
									Se a documentação do seu imóvel não está regular ou recebeu uma herança, o Radar dos Imóveis oferece 
									a assessoria jurídica e todos os serviços necessários para colocar a documentação em dia e garantir 
									sua propriedade.
				                </p>
				                <a href="#" class="more">Contate Documentação</a>
							</div>
							<div class="box-service">
								<h3>Avaliação de Imóveis</h3>
				                <p class="limit" style="text-indent:1cm;  text-align: justify; ">
				                	Avaliação para compra e venda, inclusive em processos judiciais.
									O Radar dos Imóveis possui corretores com formação específica e registro no Cadastro Nacional de 
									Avaliadores de Imóveis – CNAI para realizar a avaliação do seu imóvel.
									Se a sua necessidade for vender, mas está inseguro sobre o quanto vale o seu imóvel ou se deseja 
									comprar, mas quer saber se o preço está de acordo com o mercado, chame o Radar dos Imóveis.


				                </p>
				                <a href="#" class="more">Contate Avaliação de Imóveis</a>
							</div>
						</div>
					</div>
				</div>
				<div class="site-map">
					<div class="container">
						...
						<div class="item-site-map">
							<h2>Radar dos Imóveis</h2>
							<ul>
								<li class="active"><a href="#" class="list-items-nav">Anúncie seu imóvel</a></li>
								<!--
						...
						<div class="item-site-map">
							<ul>
								<li>
									<h2>Contato</h2>
									<span>(51) 9551-3505</span>
								</li>
								<li>
									<h2>Endereço</h2>
									<span>Av. Presidente Vargas, 1698 - Sala: 106 </span><br>
									<span>Centro - Esteio - RS</span>
								</li>
							</ul>
						</div>
					</div>
