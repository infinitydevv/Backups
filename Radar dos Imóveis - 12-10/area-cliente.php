          ...
          <div class="col-xs-12 col-sm-3 col-md-2 navbar-fixed-top col-lg-2 bloco-left can">
            <div class="row">
              ...
              <ul>
                  ...
                  <li>
                    <a href="index.php#destaque"><span class="glyphicon glyphicon-comment" aria-hidden="true"></span> Destaques da Semana</a>
                  </li>
                  <li>
                    <a href="index.php#servicos"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Serviços</a>
                  </li>
                  <li>
                  ...
                  <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                      <ul class="nav navbar-nav">
                        ...
                        <li>
                          <a href="radardosimoveis.com.br"><span class="glyphicon glyphicon-comment" aria-hidden="true"></span> Destaques da Semana</a>
                        </li>
                        <li>
                          <a href="http://radardosimoveis.com.br#servicos"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Serviços</a>
                        </li>
                        <li>
                          <a href="imoveis/index.php"><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Alterar login</a>
                        </li>
          ...
          <div class="panel panel-default">
            <div class="panel-heading" role="tab" id="headingOne">
              <h4 class="panel-title">
                <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse'.$key->idimo.'" aria-expanded="true" aria-controls="collapse'.$key->idimo.'">
            ...
            <div id="collapse'.$key->idimo.'" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
              <div class="panel-body">
                <ul class="nav nav-tabs" role="tablist">
                  <li role="presentation" class="active"><a href="#imovel'.$key->idimo.'" aria-controls="imovel'.$key->idimo.'" role="tab" data-toggle="tab">Imóvel</a></li>
                  <li role="presentation"><a href="#mensagens'.$key->idimo.'" aria-controls="mensagens'.$key->idimo.'" role="tab" data-toggle="tab">Mensagens</a></li>
                </ul>
                <!-- Tab panes -->
                <div class="tab-content">
                  <div role="tabpanel" class="tab-pane active" id="imovel'.$key->idimo.'">'; 
                  ...
                  echo '</div>
                    <div role="tabpanel" class="tab-pane" id="mensagens'.$key->idimo.'">';
