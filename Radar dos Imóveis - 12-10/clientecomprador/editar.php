...
<head>
    <meta charset="utf-8">
	<title>Edição de Cliente Comprador</title>
...
<body>
	<div class='container'>
		<fieldset>
			<legend><h1>Formulário - Edição de Cliente Comprador</h1></legend>
				...
				<div class="form-group">
					...
					<div class="form-group">
                      <label for="obs1">Descrição do Imóvel Desejado (casa, terreno, apto, rural, nº dormitórios, tamanho...):</label>
                       <textarea rows="10" cols="160" maxlength="500" name="obs1" ><?echo"$cliente->obs1"?></textarea>
                    </div>
                  ...
                  <br />              
                   ...
                   <div class="form-group">
                     <label for="obs2">Localização do imóvel (cidade, bairro, referências, rua, número...):</label>
                       <textarea rows="10" cols="160" maxlength="500" name="obs2" ><?echo"$cliente->obs2"?></textarea>
                    </div>
                  
                    <div class="form-group">
                       <label for="obs3">Valores e condições (à vista, parcelamentos, trocas...):</label>
                       <textarea rows="10" cols="160" maxlength="500" name="obs3"> <?echo"$cliente->obs3"?></textarea>
                    </div>
					
					
				    <input type="hidden" name="acao" value="editar">
				    <input type="hidden" name="id" value="<?=$cliente->idclicom?>">
