...
if (empty($termo)):
	...
	$sql = 'SELECT * FROM imovel i INNER JOIN usuario u on i.idusu = u.idusu inner join captador c on i.idcap = c.idcap inner join clientevendedor cli on i.idcliven = cli.idcliven where 1 order by i.idimo';		
				...
				<table class="table table-striped">
					...
					<?php foreach($clientes as $cliente):?>
						<tr>
							...
							<td>
								<a href='cadastro.php?idimo=<?=$cliente->idimo?>' class="show btn btn-sm show btn-warning"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
								...
								<button class="show btn btn-sm btn-primary" data-toggle="modal" data-target="#modal-mensagem<?=$cliente->idimo?>"><span class="glyphicon glyphicon-fullscreen" aria-hidden="true"></span></button>
								...
								<button class="hide btn btn-xs btn-primary btn-block" data-toggle="modal" data-target="#modal-mensagem<?=$cliente->idimo?>"><span class="glyphicon glyphicon-fullscreen" aria-hidden="true"></span></button>
								
                           
							</td>
						</tr>	
						<div class="modal fade" id="modal-mensagem<?=$cliente->idimo?>">
						    <div class="modal-dialog">
						         <div class="modal-content">
						             <div class="modal-header">
						                 <button type="button" class="close" data-dismiss="modal"><span>×</span></button>
						                 <h4 class="modal-title"><?php echo $cliente->tipoimo. ' - '.$cliente->bairro.'. '.$cliente->lougradouro.' - '.$cliente->cidade.'       R$'.number_format($cliente->valorvendaimo, 2,',','.') ?></h4>
						             </div>
					...
					<?php foreach($clientes as $cliente):?>
						<tr>
							...
							<td>
								...
								<a href='cadastro.php?idimo=<?=$cliente->idimo?>' class="show btn btn-md show btn-warning"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
								<a href='excluir.php?idimo=<?=$cliente->idimo?>' class="show btn btn-md btn-danger"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a>
								<a href='../mensagem/cadastro.php?i=<?=$cliente->idimo?>&c=<?=$cliente->idcliven?>' class="show btn btn-md btn-primary"><span class="glyphicon glyphicon-comment" aria-hidden="true"></span></a>
								<button href='#' class="show btn btn-md btn-primary" data-toggle="modal" data-target="#modal-mensagem"><span class="glyphicon glyphicon-fullscreen" aria-hidden="true"></span></button>

                               	<a href='cadastro.php?idimo=<?=$cliente->idimo?>' class="hide btn btn-xs  btn-warning btn-block "><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
								<a href='excluir.php?idimo=<?=$cliente->idimo?>' class="hide btn btn-xs btn-danger btn-block "><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a>
								<a href='../mensagem/cadastro.php?i=<?=$cliente->idimo?>&c=<?=$cliente->idcliven?>' class="hide btn btn-xs btn-primary btn-block "><span class="glyphicon glyphicon-comment" aria-hidden="true"></span></a>
								<button class="hide btn btn-xs btn-primary btn-block" data-toggle="modal" data-target="#modal-mensagem"><span class="glyphicon glyphicon-fullscreen" aria-hidden="true"></span></button>
