...
<!--
	...
	-->
		<center><?php echo '<h1> Seja Bem Vindo, ' .$logado .'</h1>';}?></center>
	<div class='container'>
	<div class='row' ><center>
		<div class="col-xs-6 col-md-4">
				<a href="imoveis/index.php"><img src='img/imovel.png'</img></a><br>
				<figcaption>IMÓVEIS</figcaption>
		</div>
		<div class="col-xs-6 col-md-4">
				<a href="usuario/index.php"><img src='img/usuario.png'</img></a>
				<figcaption>USUÁRIOS</figcaption>
		</div>
		<div class="col-xs-6 col-md-4">
				<a href="clientecomprador/index.php"><img src='img/clicom.png'</img></a>
				<figcaption>CLIENTE COMPRADOR</figcaption>
		</div>
		<div class="col-xs-6 col-md-4">		
				<a href="clientevendedor/index.php"><img src='img/clivend.png'</img></a>
				<figcaption>CLIENTE VENDEDOR</figcaption>
		</div>
		<div class="col-xs-6 col-md-4">
				<a href="logout.php"><img src='img/sair.png'</img></a>
