...
<fieldset>
  <legend>Cadastro de Usuários</legend>
	...
	<div class="form-group">
		<label for="cnai">CNAI Nº:</label>
		<input type="text" class="form-control" id="cnai" name="cnaiusu">
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		<label for="dataani">Função:</label>
		<input type="text" class="form-control" id="dataa" name="dataaniusu">
	</div>
	<div class="form-group">
...
if(@$_GET['go'] == 'cadastrar'){
	...
	if(empty($nome)){
		...
		if($query1 == 1){
			...
			@mysql_query("INSERT INTO usuario (idusu,nome,creci,funcao,email,fonecel,foneres,login,senha,foto,tipo)
