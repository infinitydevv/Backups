				...
				<table class="table table-striped">
					...
					<?php foreach($clientes as $cliente):?>
						<tr>
							...
							<td>
								<a href='editar.php?idcliven=<?=$cliente->idcliven?>' class="show btn btn-md show btn-warning">Editar</a>
								<a href='javascript:void(0)' class="show btn btn-md btn-danger" rel="<?=$cliente->idcliven?>">Excluir</a>
                               	<a href='editar.php?idcliven=<?=$cliente->idcliven?>' class="hide btn btn-xs btn-warning btn-block ">Editar</a>
								<a href='javascript:void(0)' class="hide btn btn-xs btn-danger btn-block" rel="<?=$cliente->idcliven?>">Excluir</a>
							</td>
						</tr>	
					<?php endforeach;?>
				</table>
