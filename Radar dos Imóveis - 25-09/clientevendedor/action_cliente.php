...
/*
		...
		if ($acao == 'editar'):
			...
			$sql = 'UPDATE clientevendedor SET nomecliven=:nome, cpf=:cpf, cnpj=:cnpj, email=:email, celular=:celular,telefone=:telefone, logradouro=:logradouro, numero=:numero,cep=:cep,cidade=:cidade,bairro=:bairro,conjuge=:conjuge,cpfconjuge=:cpfconjuge,pessoacontato=:pessoacontato, login=:login, senha=:senha,	obs=:obs';
