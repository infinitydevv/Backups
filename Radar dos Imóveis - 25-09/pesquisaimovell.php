		...
		echo"<div class='container-fluid'>";
			echo"<div class='row'>";
				echo"<div class='col-xs-12 col-sm-6 col-md-8'>";
						...
						if($dados->foto1 != "") { 
							echo "<a href='".$dados->foto1."'rel='shadowbox[vocation]; width=400; height=300'  ><img src='".$dados->foto1."' width='400px' heigth='500px' class='foto' alt='Foto de exibição'/></a>";
						echo"<br>";
						}
						else{ 
						echo'Sem Foto'; echo'<br>';
						}
				...
				echo"<div class='col-xs-6 col-md-4'>"; 
					echo "<span class='tipo'>$dados->tipoimo</span> <br><br>";   
						if($dados->empreendimento == 1){
							echo "".$dados->nomeempreendimento."<br>";
						}
					...
					if($dados->tipoimo == 'Terreno'){
						echo "<span class=''><img src='img/yes.png'/> Medidas: ".$dados->medidasimo."</span> <br>";
					}
