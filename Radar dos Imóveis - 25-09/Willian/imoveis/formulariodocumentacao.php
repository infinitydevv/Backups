    ...
    return $mask;
            ...
            //   if(isset($_POST["botaoc"])){
                  ...
                  */
                      ...
                      echo"<div class='c1'> <h1>Dúvidas de Documentação</h1><br>Por favor, preencha o formulario e nos envie seu contato!<br>Iremos contata-lo em horário comercial. <br><br></font></div>";
                      /*
                      ...
                      echo "<style> .c2{ position:absolute; border-radius:15px;left:700px; top:10px;color:white;
                                     ...
                                     .c2 img{padding:5px;}
                                         ...
                                         <div class='c2'><img src='$foto'width='150px'height='150px'>
                                          <span class='tex'>SEU CORRETOR<br><br>
                                          $nome <br>
				...
				*/
                    ...
                    echo"<style> .c1{ position:relative;border-radius:15px; left:10px; top:10px;color:white;
                      ...
                      echo"<div class='c1'> <h1> Dúvidas com Documentação </h1><br>Por favor, preencha o formulario e nos envie seu contato!<br>Iremos contata-lo em horário comercial. <br><br></font></div>";
                      echo "<style> .c2{ position:absolute; border-radius:15px;left:700px; top:10px;color:white;
                                         font-family:helvetica;font-size:12pt;padding:5px;width:450px;
                                         height:170px;text-align:left; background-color: #FF8000;}
                                     .tex{position:absolute; left:160px; font-weight: bold;padding-top:10px;padding-bottom:25px;}
...
<br>
                  ...
                  <form action="formularioD.php" method="post">
                   ...
                   <input type="hidden" name="var" id="var" value="<?php print $dados['email'] ?>" />         
                    ...
                    <div class="form-group">
                       <label for="telefone">Fone (whatsapp/Cel/Fixo):</label>
                  ...
                  <!-- ENDEREÇO -->
                    ...
                    <div class="form-group">
                      <label for="obs1">Descreva sua necessidade de documentação (ex.: Escritura, inventário, registro):</label>
