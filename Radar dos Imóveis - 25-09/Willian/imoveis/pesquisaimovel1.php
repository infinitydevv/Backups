				...
				<div class="caixapes">
					...
					<H3>Resultado de sua consulta !!</H3>  
					  ...
					  <?php
						...
						if($codigo !="" && $tipo !="" && $cidade!="" && $bairro!="" && $valor!=""){
						   ...
						   //SELECT * FROM `imovel` WHERE (cidade='Gravatai' and bairro='Centro' and valorvendaimo between 30000 and 1000000)
						if($valor == '<50000.00'){
						$sql = "SELECT * FROM imovel WHERE tipo like '%$tipo' or cidade like '%$cidade' or bairro like '%$bairro' or valorvendaimo <= $valor";
					  // echo $sql;
					   }else if($valor == '50000.00 and 100000.00'){
						$sql = "SELECT * FROM imovel WHERE (tipo = '$tipo' or cidade='$cidade' or bairro='$bairro' or valorvendaimo between $valor)";
					  // echo $sql;
					...
					if($dados->ativo != 0){               
							...
							//echo "<center><a href='$dados->foto1' ><img src='$dados->foto1' heigth='40%' width='30%' class='foto' alt='Foto de exibição'/></a></center><br>";	
							   ...
							   echo "<center><a href='".$dados->foto1."'rel='shadowbox[vocation]; width=600px; height=300px'  ><img src='".$dados->foto1."' width='60px' heigth='40px' class='foto' alt='Foto de exibição'/></a></center>";
							   echo "Código:".$dados->idimo."<br>";
							   echo "<span class='cidade'> $dados->cidade.</span><br>  ";
							   echo "Bairro:".$dados->bairro."<br>";               
							   echo "Nº Dormitórios:".$dados->numdormimo."<br>";
