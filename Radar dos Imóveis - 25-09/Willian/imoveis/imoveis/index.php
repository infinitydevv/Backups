...
if (empty($termo)):
	...
	$sql = 'SELECT idimo, tipoimo, cidade, valorvendaimo FROM imovel';
...
<body>
	...
	<div class='container'>
		<fieldset>
			...
			<legend><h1>Listagem de Imóveis <img id="icone" width="50px" height="50px" src = "../img/logonovo.png"/> <a href='../area.php' class="btn btn-success pull-right">Retornar</a><br></h1></legend>
					...
					<?php foreach($clientes as $cliente):?>
						<tr>
							...
							<td>
								...
								<a href='cadhistorico.php?idimo=<?=$cliente->idimo?>' class="btn btn-primary">Histórico</a>
