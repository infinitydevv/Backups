...
//****************************************
	   $banco="radardosimovei";
	   $login="radardosimovei";
	   $servidor="mysql.radardosimoveis.com.br";
	   $senha="Radar2015";
	...
	if($arquivo1 <> '../imoveis/fotosprodutos/padrao.png'){
		...
		$arq_name1="../imoveis/fotosprodutos/".$nome_foto;
		$arq_tmp=$_FILES['foto1']['tmp_name'];
		move_uploaded_file($arq_tmp,"../imoveis/fotosprodutos/".$nome_foto);
		
		
		
		
		$crud = new crud('imovel');
        $crud->atualizar("foto1='$arq_name1'", "idimo='$getId'"); 
	...
	if($arquivo1 <> '../imoveis/fotosprodutos/padrao.png'){
		...
		$nome_foto = 'padrao.png';
		$arq_name2="../imoveis/fotosprodutos/".$nome_foto;
		$arq_tmp=$_FILES['foto2']['tmp_name'];
		move_uploaded_file($arq_tmp,"../imoveis/fotosprodutos/".$nome_foto);
		...
		$crud = new crud('imovel');
        $crud->atualizar("foto2='$arq_name2'", "idimo='$getId'"); 
	...
	if($arquivo1 <> '../imoveis/fotosprodutos/padrao.png'){
		...
		$nome_foto = 'padrao.png';
		$arq_name3="../imoveis/fotosprodutos/".$nome_foto;
		$arq_tmp=$_FILES['foto3']['tmp_name'];
		move_uploaded_file($arq_tmp,"../imoveis/fotosprodutos/".$nome_foto);
		...
		$crud = new crud('imovel');
        $crud->atualizar("foto3='$arq_name3'", "idimo='$getId'"); 
	...
	if($arquivo1 <> '../imoveis/fotosprodutos/padrao.png'){
		...
		$nome_foto = 'padrao.png';
		$arq_name4="../imoveis/fotosprodutos/".$nome_foto;
		$arq_tmp=$_FILES['foto1']['tmp_name'];
		move_uploaded_file($arq_tmp,"../imoveis/fotosprodutos/".$nome_foto);
		...
		$crud = new crud('imovel');
        $crud->atualizar("foto4='$arq_name4'", "idimo='$getId'"); 
	...
	if($arquivo1 <> '../imoveis/fotosprodutos/padrao.png'){
		...
		$nome_foto = 'padrao.png';
		$arq_name5="../imoveis/fotosprodutos/".$nome_foto;
		$arq_tmp=$_FILES['foto1']['tmp_name'];
		move_uploaded_file($arq_tmp,"../imoveis/fotosprodutos/".$nome_foto);
		...
		$crud = new crud('imovel');
        $crud->atualizar("foto5='$arq_name5'", "idimo='$getId'"); 
	...
	if(isset ($_POST['gravar'])){  
		...
		$subapar=$_POST['subapar'];
		$endereco=$_POST['endereco'];
		$numero=$_POST['numero'];
		$bairro=$_POST['bairro'];
		$cidade=$_POST['cidade']; 
		$cep= $_POST['cep'];     
		$estado= 'RS';//$_POST['estado'];
		$bloco=$_POST['bloco']; 
		...
		$n = rand (0,100000);
		$arq_name =$n. $_FILES['foto1']['name'];
		$arq_name1="../imoveis/fotosprodutos/".$arq_name;
		$arq_tmp11=$_FILES['foto1']['tmp_name'];
		move_uploaded_file($arq_tmp11,"../imoveis/fotosprodutos/".$arq_name);
		}
		}
		if($acao2 == 'incluir'){
		if(isset($_FILES['foto2']) && $_FILES['foto2']['size'] == 0){
        		
		$nome_foto1 = 'padrao.png';
		$arq_name2="../imoveis/fotosprodutos/".$nome_foto1;
		$arq_tmp=$_FILES['foto2']['tmp_name'];
		move_uploaded_file($arq_tmp,"../imoveis/fotosprodutos/".$nome_foto1);
		
		}else{
		$n1 = rand (0,100000);
		$arq_nameum =$n1. $_FILES['foto2']['name'];
		$arq_name2="../imoveis/fotosprodutos/".$arq_nameum;
		$arq_tmpum=$_FILES['foto2']['tmp_name'];
		move_uploaded_file($arq_tmpum,"../imoveis/fotosprodutos/".$arq_nameum);
		}
		}
		if($acao3 == 'incluir'){
		if(isset($_FILES['foto3']) && $_FILES['foto3']['size'] == 0){
        		
		$nome_foto3 = 'padrao.png';
		$arq_name3="../imoveis/fotosprodutos/".$nome_foto3;
		$arq_tmp33=$_FILES['foto3']['tmp_name'];
		move_uploaded_file($arq_tmp33,"../imoveis/fotosprodutos/".$nome_foto3);
		
		}else{
		$n2 = rand (0,100000);
		$arq_namedois =$n2.$_FILES['foto3']['name'];
		$arq_name3="../imoveis/fotosprodutos/".$arq_namedois;
		$arq_tmpdois=$_FILES['foto3']['tmp_name'];
		move_uploaded_file($arq_tmpdois,"../imoveis/fotosprodutos/".$arq_namedois);
		}
		}
		if($acao4 == 'incluir'){
		if(isset($_FILES['foto4']) && $_FILES['foto4']['size'] == 0){
        		
		$nome_foto4 = 'padrao.png';
		$arq_name4="../imoveis/fotosprodutos/".$nome_foto4;
		$arq_tmp333=$_FILES['foto4']['tmp_name'];
		move_uploaded_file($arq_tmp333,"../imoveis/fotosprodutos/".$nome_foto4);
		
		}else{
		$n3 = rand (0,100000);
		$arq_nametres =$n3. $_FILES['foto4']['name'];
		$arq_name4="../imoveis/fotosprodutos/".$arq_nametres ;
		$arq_tmptres =$_FILES['foto4']['tmp_name'];
		move_uploaded_file($arq_tmptres ,"../imoveis/fotosprodutos/".$arq_nametres );
		}
		}
		if($acao5 == 'incluir'){
		if(isset($_FILES['foto5']) && $_FILES['foto5']['size'] == 0){
        		
		$nome_foto5 = 'padrao.png';
		$arq_name5="../imoveis/fotosprodutos/".$nome_foto5;
		$arq_tmp111=$_FILES['foto5']['tmp_name'];
		move_uploaded_file($arq_tmp111,"../imoveis/fotosprodutos/".$nome_foto5);
		
		}else{
		$n4 = rand (0,100000);
		$arq_namequatro =$n4. $_FILES['foto5']['name'];
		$arq_name5="../imoveis/fotosprodutos/".$arq_namequatro;
		$arq_tmpquatro=$_FILES['foto5']['tmp_name'];
		move_uploaded_file($arq_tmpquatro,"../imoveis/fotosprodutos/".$arq_namequatro);
		}
		}
		...
		$crud = new crud('imovel'); 
        $crud->inserir("idusu,ativo,datacadimo,idcliven,tipoimo,tipo,subapar,lougradouro,numero,bloco,bairro,cidade,cep,estado,numdormimo,areaimo,vagasimo,
		...
		medidasimo,foto1,foto2,foto3,foto4,foto5,destaqueimo,empreendimento,nomeempreendimento,numunidades,numandares,numpredios,aptosporandar,esperasplit,sacada,quadraesporte,mcmv,numlote",
		
		
		"'$nomeusu','$ativo','$datacad','$cliven','$tipoimo','$subtipo','$subapar','$endereco','$numero','$bloco','$bairro','$cidade','$cep','$estado','$dormitorio','$areautil','$vagas',
		...
		'$medidas','$arq_name1','$arq_name2','$arq_name3','$arq_name4','$arq_name5','$destaque','$emp','$empreendimento','$numunidades','$numandares','$numpredios','$aptosporandar','$split','$sacada','$quadra','$MCMV','$numlote'","idimo='$getId'"); 
	...
	if(isset ($_POST['editar'])){ 
		...
		$arq_name1="../imoveis/fotosprodutos/".$arq_name;
		$arq_tmp=$_FILES['foto1']['tmp_name'];
		move_uploaded_file($arq_tmp,"../imoveis/fotosprodutos/".$arq_name);
	...
	if(isset ($_POST['editar'])){ 	
	 ...
	 if(isset ($_POST['editar'])){ 
		...
		medidasimo='$medidas',destaqueimo='$destaque',empreendimento='$emp',nomeempreendimento='$empreendimento',numunidades='$numunidades',numandares='$numandares',numpredios='$numpredios',aptosporandar='$aptosporandar',esperasplit='$split',sacada='$sacada',quadraesporte='$quadra',mcmv='$MCMV',numlotes='$numlote'", "idimo='$getId'"); 
        echo"<meta http-equiv='refresh' content='0; url=../imoveis/index.php' />";
    }
...
// Por Mario Bruno Morais Aliste
  ...
  function Inibe() {
	...
	document.formulario.subtipo.disabled = true;
  document.formulario.subapar.disabled = true;	
  
 }

 function casa() {
	
  document.formulario.subtipo.disabled = false;
  document.formulario.subapar.disabled = true;
 }
 function apartamento() {
	
  document.formulario.subtipo.disabled = true;
  document.formulario.subapar.disabled = false;
 }
 function outros() {
...
<body onload="Inibe()">
	<div class='container'>
		<fieldset>
			...
			<form action="" name="formulario" method="POST" id='form-contato' enctype='multipart/form-data'>
	 ...
	 <!--<div class="form-group">
	  ...
	  <?php
						if($campo['idimo']){
							if($campo['tipoimo'] == 'Casa'){
							echo "<div class='form-group'>"	;
							echo "<label for='dataani'>Imóvel Ativo?</label>";
								echo "<label class='radio-inline' for='tipo'>Tipo do Imóvel:</label>";
								echo "<input class='radio-inline' type='radio' onClick='casa()'  id='datac' name='tipoimo' value='Casa'checked />Casa";
								echo "<input class='radio-inline' type='radio' onClick='apartamento()' name='tipoimo' value='Apartamento' />Apartamento";
								echo "<input class='radio-inline' type='radio' onClick='outros()'  name='tipoimo' value='Terreno' />Terreno";
								echo "<input class='radio-inline' type='radio' onClick='outros()'  name='tipoimo' value='Rural' />Rural";
								echo "<input class='radio-inline' type='radio' onClick='outros()'  name='tipoimo' value='Comercial' />Comercial";
							echo "</div>";
							}else if($campo['tipoimo'] == 'Apartamento'){
								echo "<div class='form-group'>"	;
								echo "<label class='radio-inline' for='tipo'>Tipo do Imóvel:</label>";
								echo "<input class='radio-inline' type='radio' onClick='casa()'  id='datac' name='tipoimo' value='Casa' />Casa";
								echo "<input class='radio-inline' type='radio' onClick='apartamento()' name='tipoimo' value='Apartamento' checked/>Apartamento";
								echo "<input class='radio-inline' type='radio' onClick='outros()'  name='tipoimo' value='Terreno' />Terreno";
								echo "<input class='radio-inline' type='radio' onClick='outros()'  name='tipoimo' value='Rural' />Rural";
								echo "<input class='radio-inline' type='radio' onClick='outros()'  name='tipoimo' value='Comercial' />Comercial";
								echo "</div>";
							}else if($campo['tipoimo'] == 'Terreno'){
								echo "<div class='form-group'>"	;
								echo "<label class='radio-inline' for='tipo'>Tipo do Imóvel:</label>";
								echo "<input class='radio-inline' type='radio' onClick='casa()'  id='datac' name='tipoimo' value='Casa' />Casa";
								echo "<input class='radio-inline' type='radio' onClick='apartamento()' name='tipoimo' value='Apartamento' />Apartamento";
								echo "<input class='radio-inline' type='radio' onClick='outros()'  name='tipoimo' value='Terreno' checked/>Terreno";
								echo "<input class='radio-inline' type='radio' onClick='outros()'  name='tipoimo' value='Rural' />Rural";
								echo "<input class='radio-inline' type='radio' onClick='outros()'  name='tipoimo' value='Comercial' />Comercial";
								echo "</div>";
							}else if($campo['tipoimo'] == 'Rural'){
								echo "<div class='form-group'>"	;
								echo "<label class='radio-inline' for='tipo'>Tipo do Imóvel:</label>";
								echo "<input class='radio-inline' type='radio' onClick='casa()'  id='datac' name='tipoimo' value='Casa' />Casa";
								echo "<input class='radio-inline' type='radio' onClick='apartamento()' name='tipoimo' value='Apartamento' />Apartamento";
								echo "<input class='radio-inline' type='radio' onClick='outros()'  name='tipoimo' value='Terreno' />Terreno";
								echo "<input class='radio-inline' type='radio' onClick='outros()'  name='tipoimo' value='Rural' checked/>Rural";
								echo "<input class='radio-inline' type='radio' onClick='outros()'  name='tipoimo' value='Comercial' />Comercial";
								echo "</div>";
							}else if($campo['tipoimo'] == 'Comercial'){
								echo "<div class='form-group'>"	;
								echo "<label class='radio-inline' for='tipo'>Tipo do Imóvel:</label>";
								echo "<input class='radio-inline' type='radio' onClick='casa()'  id='datac' name='tipoimo' value='Casa'/>Casa";
								echo "<input class='radio-inline' type='radio' onClick='apartamento()' name='tipoimo' value='Apartamento' />Apartamento";
								echo "<input class='radio-inline' type='radio' onClick='outros()'  name='tipoimo' value='Terreno' />Terreno";
								echo "<input class='radio-inline' type='radio' onClick='outros()'  name='tipoimo' value='Rural' />Rural";
								echo "<input class='radio-inline' type='radio' onClick='outros()'  name='tipoimo' value='Comercial'checked  />Comercial";
								echo "</div>";
							}
						...
						?>
	  <div class="form-group">
	  <label for="tipo">Sub-Tipo casa:</label>
				<select name="subtipo" class="form-control" id="subtipo">
	  ...
	  <div class="form-group">
	  <label for="tipo">Sub-Tipo apartamento:</label>
				<select name="subapar" class="form-control" id="subapar">
                    <option value="<?php echo $campo['subapar']?>"><?php echo $campo['subapar'] ?></option>
    ...
    <div class="form-group">
		<label for="dados">Complemento:</label>
	...
	<fieldset>
	  <legend>Dados do Empreendimento </legend>
						...
						if($campo['idimo']){
							...
							echo "<input type='radio' onClick='Exibe()' id='datac' name='emp' value='1' checked/>Sim";
							echo "<input type='radio' onClick='Inibe()'  name='emp' value='0' />Não";
							echo "</div>";
							}else{
								echo "<div class='form-group'>"	;
								echo "<label for='dataani'>É um Empreendimento?</label>";
								echo "<input type='radio' onClick='Exibe()' id='datac' name='emp' value='1' />Sim";
								echo "<input type='radio' onClick='Inibe()' name='emp' value='0' checked/>Não";
								echo "</div>";
							}
	 ...
	 <div class="form-group">
		<label for="dados">Nº Lote:</label>
		<input type="text" class="form-control" id="numlote" name="numlote" placeholder="Nº de Lote" value="<?php echo $campo['numlote']?>">
	</div> 
	...
	<div class="form-group">
		...
		<input type="text" class="money form-control" id="condominio" name="valcondominio" placeholder="R$" value="<?php echo $campo['valorcondominioimo']?>" onKeyPress="return(MascaraMoeda(this,'.',',',event))">
	</div>
	
	<div class="form-group">
		<label for="iptu">Valor do IPTU: </label>
		<input type="text" class="money form-control" id="moeda" name="iptu" placeholder="R$"   value="<?php echo $campo['valoriptuimo']?>">
	</div>
	...
	<label for="calcado">Calçado:</label>
		...
		<?php if(@$getId){ ?>
			...
			<div class="row">
				<label for="nome">Foto 1</label>
				    <div class="col-md-2">
						 <a href="#" class="thumbnail">
						    <img src="<?php echo $campo['foto1']?>" height="190" width="150" id="foto-cliente">
						 </a>
					 </div>
					 
					 <input name="foto1" type="file" id="foto1"  size="28">
					 <input type="submit" class="btn btn-primary" name="excluir" value="Excluir foto" />
	  ...
	  <?php if(@$getId){ ?>
			...
			<div class="row">
				<label for="nome">Foto 2</label>
				    <div class="col-md-2">
						 <a href="#" class="thumbnail">
						    <img src="<?php echo $campo['foto2']?>" height="190" width="150" id="foto-cliente">
						 </a>
					 </div>
				 <input name="foto2" type="file" id="foto2"  size="28">
				 <input type="submit" class="btn btn-primary" name="excluir1" value="Excluir foto" />
		...
		?>		<label for="nome">Foto 2</label>
				<input name="foto2" type="file" id="foto2"  size="28">
				 <input type="hidden" name="acao2" value="incluir">
	 ...
	 <?php if(@$getId){ ?>
			...
			<div class="row">
				<label for="nome">Foto 3</label>
				    <div class="col-md-2">
						 <a href="#" class="thumbnail">
						    <img src="<?php echo $campo['foto3']?>" height="190" width="150" id="foto-cliente">
						 </a>
					 </div>
					
				 <input name="foto3" type="file" id="foto3"  size="28">
				 <input type="submit" class="btn btn-primary" name="excluir2" value="Excluir foto" />
				  <input type="hidden" name="acao3" value="editar">
				 </div>		 
		 <?php
		}else{		
		?>		 <label for="nome">Foto 3</label>
				<input name="foto3" type="file" id="foto3"  size="28">
				 <input type="hidden" name="acao3" value="incluir">
	 ...
	 <?php if(@$getId){ ?>
			...
			<div class="row">
				<label for="nome">Foto 4</label>
				    <div class="col-md-2">
						 <a href="#" class="thumbnail">
						    <img src="<?php echo $campo['foto4']?>" height="190" width="150" id="foto-cliente">
						 </a>
					 </div>
					
				 <input name="foto4" type="file" id="foto4"  size="28">
				 <input type="submit" class="btn btn-primary" name="excluir3" value="Excluir foto" />
				  <input type="hidden" name="acao4" value="editar">
				 </div>		 
		 <?php
		}else{		
		?>		 <label for="nome">Foto 4</label>
				<input name="foto4" type="file" id="foto4"  size="28">
				 <input type="hidden" name="acao4" value="incluir">
	 ...
	 <div class="form-group">
		<?php if(@$getId){ ?>
			<div class="row">
				<label for="nome">Foto 5</label>
				    <div class="col-md-2">
						 <a href="#" class="thumbnail">
						    <img src="<?php echo $campo['foto5']?>" height="190" width="150" id="foto-cliente">
						 </a>
					 </div>
					 
				 <input name="foto5" type="file" id="foto5"  size="28">
				 <input type="submit" class="btn btn-primary" name="excluir4" value="Excluir foto" />
				 <input type="hidden" name="acao5" value="editar">
		 	</div>
			<?php
			}else{		
			?>	
					<label for="nome">Foto 5</label>
					<input name="foto5" type="file" id="foto5"  size="28">
					<input type="hidden" name="acao5" value="incluir">
			<?php } ?>
     </div>
	 ...
	 <div class="form-group">  
	   ...
	   <div class="form-group">
		...
		<input type="text" class="form-control" id="valvenda" name="valvenda" placeholder="100.000,00" value="<?php echo $campo['valorvendaimo']?>">
	</div>
					<?php
						if($campo['idimo']){
							if($campo['mcmv'] == 1){
