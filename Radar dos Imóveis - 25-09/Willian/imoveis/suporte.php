...
<section id="representa" class="representa">
        <div class="container">
            <div class="row">
				...
				<br><br>
                    <h1>DOCUMENTAÇÃO</h1> <!--class="lead"-->
                    <p >Se a documentação do seu imóvel não está regular ou recebeu uma herança, o Radar dos Imóveis oferece
	...
	<center>
	<h1>DÚVIDAS COM DOCUMENTAÇÕES?</h1>
			<br/>
            <a href="formulariodocumentacao.php" class="btn btn-dark btn-lg">Solicite Contato</a></center>
        </div>
