  ...
  <!-- inicio do segundo menu-->
    ...
    <header id="top" class="header">
		...
		<select name="cidade">
                ...
                <option value="sc">Sapucaia do Sul</option>
                <option value="rj">Esteio</option>
                <option value="pr">Novo Hamburgo</option>
        </select>
		
		
		<select name="valor">
                <option value="qf">Qualquer faixa de preço</option>
                <option value="sc">Até R$ 100.000,00</option>
                <option value="rj">De R$ 100.001,00 a R$ 200.000,00</option>
                <option value="pr">Acima de R$ 200.000,00</option>
        </select>
		
		
		<select name="dormitorio">
                <option value="qf">Dormitório</option>
                <option value="sc">1</option>
                <option value="rj">2</option>
