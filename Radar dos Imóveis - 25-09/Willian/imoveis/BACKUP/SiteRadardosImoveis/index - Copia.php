    ...
    <header id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="item active">
                ...
                <div class="fill" style="background-image:url('img/slider/faixa1.jpg');"></div>
            ...
            <div class="item">
                ...
                <div class="fill" style="background-image:url('img/slider/faixa2.jpg');"></div>
                <div class="carousel-caption">
            ...
            <div class="item">
                ...
                <div class="fill" style="background-image:url('img/slider/faixa3.jpg');"></div>
                <div class="carousel-caption">
...
<!-- fim do primeiro menu-->
    ...
    <header id="top" class="header">
        <div class="text-vertical-center">
			...
			<img src="img/RADAR.png" alt="Radar dos Imóveis" title="" width="280" height="280" />
