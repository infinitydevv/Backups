...
//se nao existir a pasta ele cria uma
	...
	/*FIM DA FOTO */			
		...
		@mysql_query("insert into imovel (idimo, idusu, datacadimo, idcli,
			 ...
			 '$portaria', '$servico', '$piscina','$academia', '$valimo', '$plano', '$inclinado', '$gramado', '$calcado','$comissao', '$valvenda', '$obs',
			 NULL, '$medidas',NULL,'$arq1_name', '$arq2_name', '$arq3_name', '$arq4_name', '$arq5_name')");
