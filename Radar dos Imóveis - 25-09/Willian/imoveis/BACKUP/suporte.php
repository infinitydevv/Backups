...
<section id="representa" class="representa">
        <div class="container">
            <div class="row">
				...
				<br><br>
                    <h2>Suporte</h2> <!--class="lead"-->
                    <p >Suporte na regularização documentos: escrituras, inventários e registros.</p>

<p>Se você necessita regularizar a documentação do seu imóvel ou recebeu uma herança, o Radar dos Imóveis oferece 
a assessoria jurídica necessária para garantir sua posse.
