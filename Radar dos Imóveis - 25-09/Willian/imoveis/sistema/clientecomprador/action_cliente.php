...
<body>
	<div class='container box-mensagem-crud'>
		...
		if ($acao == 'incluir'):
			...
			$sql = 'INSERT INTO clientecomprador (nome, cpf, email,celular,telefone,logradouro,numero,cep,cidade,bairro,status)
							   VALUES  (:nome,:cpf,:email,:celular,:telefone,:logradouro,:numero,:cep,:cidade,:bairro,:status)';
		...
		if ($acao == 'editar'):
			...
			$sql = 'UPDATE clientecomprador SET nome=:nome, cpf=:cpf, email=:email, celular=:celular,telefone=:telefone, logradouro=:logradouro, numero=:numero,cep=:cep,cidade=:cidade,bairro=:bairro,status=:status';
