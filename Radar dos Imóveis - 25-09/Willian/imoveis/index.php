        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse menu-navegacao" id="menu-navegacao">
                <ul class="nav navbar-nav navbar-right">
					...
					<li>
                        <a href="login1.php" onclick = $("#menu-close").click();>Cliente</a>
                    </li>
			...
			<div class = "col-xs-8 col-md-8">
				<div class="corretor">
					...
					<div class="form-group row">
						...
						<option value = '6'>Dois Irmãos</option>
					   ...
					   ?>
						...
						<input type="submit" class="botaox"  value="Vender" />
					</div>
					</form>
				</div>
			<div class="caixalogo">
				<span class="comprar"> <h2>QUER COMPRAR? <br>Faça a pesquisa:</h2></span>
				...
				<div class = "col-xs-4 col-md-4">
					...
					<table  width="40px" border="0"> 
						<tr><td> 
							...
							<input type="text" name="codigo" maxlength="5"size="10" placeholder="Informe Cód."></td><td>
							...
							<input class="botaop" type="submit" value="Pesquisar" />   
