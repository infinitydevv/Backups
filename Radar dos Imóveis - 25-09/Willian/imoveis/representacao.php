...
<section id="representa" class="representa">
        <div class="container">
            <div class="row">
				...
				<br><br>
                    <h1>COMPRA E VENDA</h1> <!--class="lead"-->
                       <p >Os corretores do Radar dos Imóveis são especializados na compra e venda de imóveis residenciais, 
					   comerciais e rurais e lhe prestam toda a segurança no momento da negociação.</p><br>
				<h1>SE A SUA NECESSIDADE FOR COMPRAR</h1>

				<p>Selecione um município e escolha o imóvel da sua preferência entre as ofertas. Verifique que cada 
				...
				<p>Indique a cidade onde deseja vender e envie mensagem ao corretor para disponibilizar sua oferta no 
				Radar dos Imóveis.</p>
	...
	<center>
		<h1>O QUE VOCÊ DESEJA?</h1>
			<br/>
            <a href="index.php" class="btn btn-dark btn-lg">Comprar</a> <b> ou </b>
			<a href="index.php" class="btn btn-dark btn-lg">Vender</a></center>
        </div>
