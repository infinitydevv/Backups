...
<div id="dialog" title="Seu E-mail foi Enviado com Sucesso!!">
    <p>Ficamos felizes com seu contato! <br> Nossos Corretores Imobiliários já estão rastreando 
      as opções para você.<br> Retornaremos o contato em breve.
	  <br><br>Obrigado.<br><br><br>Radar dos Imóveis</p>
</div>
...
//if (isset($_POST['BTEnvia'])) {
  ...
  $email_reply = $email; 
  $email_assunto = "Quero Comprar!!!"; // Este será o assunto da mensagem
  //====================================================
