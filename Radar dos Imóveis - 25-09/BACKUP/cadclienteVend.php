            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
					...
					<li>
						...
						<li><a href="cadcliente.php">Clientes Comprador</a></li>
						<li><a href="cadclienteVend.php">Clientes Vendedor</a></li>
...
<fieldset>
  <legend>Cadastro de Cliente -  Vendedor</legend>
	...
	<div class="form-group">
	  <label for="tipo">O que deseja Vender?</label>
				<select name="tipocli" class="form-control" id="tipocli">
                    <option value="">--</option>
                    <option value="Sitio">Apartamento</option>
					<option value="Chácara">Casa</option>
					<option value="Fazenda">Terreno</option>
	   ...
	   <div class="form-group">
         <label for="comment">Detalhes do Imóvel:</label>
		 <textarea class="form-control ckeditor" rows="5" name="obs1cli" placeholder="Observações detalhadas"></textarea>
       
     </div>
	 
	  <div class="form-group">
         <label for="comment">Valor do Imóvel e Formas de Pagamento:</label>
		 <textarea class="form-control ckeditor" rows="5" name="obs2cli" placeholder="Observações sobre o valor e formas de pagamento"></textarea>
...
if(@$_GET['go'] == 'cadastrar'){
	...
	if(empty($nomecli)){
		...
		echo "<script>alert('Preencha o cpf do conjugue para se cadastrar.'); history.back();</script>";
			...
			@mysql_query("INSERT INTO clienteV (idcliv,nomecliv,cpfcliv,rgcliv, datanascli, fonerescliv, fonecelcliv, emailcliv,  tipocliv, obs1cliv, obs2cliv )
            VALUES (null,'$nomecli','$cpfcli','$rgcli','$datanascli','$fonerescli','$fonecelcli','$emailcli','$tipocli','$obs1cli','$obs1cli')");
