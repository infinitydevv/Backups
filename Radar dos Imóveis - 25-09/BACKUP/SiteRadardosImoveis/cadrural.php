...
<fieldset>
  <legend>FICHA DE CADASTRO DE IMÓVEL - RURAL </legend>
  ...
  <div class="form-group row">
   ...
   <div class="form-group">
	  ...
	  <div class="form-group">
		<label for="areautil">Área: </label>
		<input type="text" class="form-control" id="areautil" name="areautil" placeholder="300 m">
	</div>
	 ...
	 <div class="form-group">
	  ...
	  <div class="form-group">
         <label for="comment">Condições:</label>
