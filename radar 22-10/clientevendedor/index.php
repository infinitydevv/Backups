...
if (empty($termo)):
	...
	$sql = 'SELECT * FROM clientevendedor where 1';
					...
					<?php foreach($clientes as $cliente):?>
						<tr>
							...
							<td>
								...
								<a href='javascript:void(0)' class="show btn btn-sm btn-danger" rel="<?=$cliente->idcliven?>"><span class="glyphicon glyphicon-remove" aria-hidden="true"></a>
					...
					<?php foreach($clientes as $cliente):?>
						<tr>
							...
							<td>
								...
								<a href='javascript:void(0)' class="hide btn btn-xs btn-danger btn-block" rel="<?=$cliente->idcliven?>"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a>
