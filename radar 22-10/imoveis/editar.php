	...
	<div class='container'>
					...
					<legend>Dados Gerais </legend>
						<div class="form-group">
							...
							<?php
								...
								$ops='';
								$pdo = new PDO('mysql:host=localhost;dbname=radardos_imoveis', 'radardosimoveisc', 'Alterar1234');
	  ...
	  <label for="tipo">Cliente:</label>
		...
		header("content-type: text/html;charset=utf-8");
			$ops='';
			$pdo = new PDO('mysql:host=localhost;dbname=radardos_imoveis', 'radardosimoveisc', 'Alterar1234');
			$stmt = $pdo->query("SELECT idcliven,nomecliven FROM clientevendedor");
			@mysql_query("SET NAMES 'utf8'");
		//$stmt = $pdo->execute();
			while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
				$ops.= "<option value='" . $row['idcliven'] . "'>" . $row['nomecliven'] . "</option>";
			}
	  ...
	  <div class="form-group">
		<div class="row">
			<label for="nome">Selecionar Foto 1</label>
				...
				<input type="file" name="foto1" id="foto1"  value="<?=$cliente->foto1?>">
		</div>
	</div>
	...
	<div class="form-group">
		<div class="row">
			<label for="nome">Selecionar Foto 2</label>
				...
				<input type="file" name="foto2" id="foto2"  value="<?=$cliente->foto2?>" >
		</div>
    </div>			
	...
	<div class="form-group">
		<div class="row">
			<label for="nome">Selecionar Foto 3</label>
				...
				<input type="file" name="foto3" id="foto3"  value="<?=$cliente->foto3?>" >
		</div>
    </div>
    ...
    <div class="form-group">
		<div class="row">
			<label for="nome">Selecionar Foto 4</label>
				...
				<input type="file" name="foto4" id="foto4"  value="<?=$cliente->foto4?>">
		</div>
    </div>	
    ...
    <div class="form-group">
		<div class="row">
			<label for="nome">Selecionar Foto 5</label>
				...
				<input type="file" name="foto5" id="foto5"  value="<?=$cliente->foto5?>">
		</div>
    </div>	
