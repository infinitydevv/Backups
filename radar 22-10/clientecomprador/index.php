					...
					<?php foreach($clientes as $cliente):?>
						<tr>
							...
							<td>
								...
								<a href='javascript:void(0)' class="show btn btn-md btn-danger" rel="<?=$cliente->idclicom?>"><span class="glyphicon glyphicon-remove" aria-hidden="true"></a>
					...
					<?php foreach($clientes as $cliente):?>
						<tr>
							...
							<td>
								...
								<a href='javascript:void(0)' class="hide btn btn-xs btn-danger btn-block" rel="<?=$cliente->idclicom?>"><span class="glyphicon glyphicon-remove" aria-hidden="true"></a>
